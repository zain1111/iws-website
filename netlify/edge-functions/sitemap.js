...
export default async (request) => {
  ...
  const staticPages = [
    ...
    { path: "/services/web-design", changefreq: "monthly", priority: "0.75" },
    { path: "/services/custom-development", changefreq: "monthly", priority: "0.75" },
    { path: "/services/wordpress-cms", changefreq: "monthly", priority: "0.75" },
    { path: "/services/ecommerce", changefreq: "monthly", priority: "0.75" },
    { path: "/services/seo-performance", changefreq: "monthly", priority: "0.75" },
    { path: "/services/care-maintenance", changefreq: "monthly", priority: "0.75" },
