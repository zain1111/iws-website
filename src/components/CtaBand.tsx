      ...
      >
        <Reveal>
          ...
          <p className="text-white/90 mt-6 max-w-lg mx-auto">
            Free 20-minute strategy call. No deck, no pressure — just a straight
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 font-mono text-sm text-navy-900/80">
            ...
            <a href={CONTACT.whatsappHref} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              {CONTACT.phoneDisplay}
            </a>
            <span className="hidden sm:inline text-white/40">·</span>
            <a href={CONTACT.upwork} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              Upwork
            </a>
            <span className="hidden sm:inline text-white/40">·</span>
